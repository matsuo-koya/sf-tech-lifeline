...
// ---- 最近の新機能(手で追記する) ----
const FEATURES = [
  { d: "2026-08-08", t: "「テーマの糸」を追加しました。歌声合成やCG、ネット文化、宇宙観測など19本のテーマを選ぶと、関連項目が年代順に自動再生されます(読み上げ・速度切り替えつき。左右の背景には同じころの別ジャンルの出来事が薄く流れます)" },
...
const READINGS = {
  ...
  伊達杏子: "ダテキョウコ",
  VTuber: "ブイチューバー",
  // 「数〜」は「かず」と読まれがちなので、本文に出てくる形をまとめて指定する
  数万人: "スウマンニン",
  数千人: "スウセンニン",
  数百万人: "スウヒャクマンニン",
  数億人: "スウオクニン",
